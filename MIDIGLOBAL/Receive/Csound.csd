...
instr 1
    ...
    aHarm1 oscili iAmp*0.5, iFreq*2
    aHarm2 oscili iAmp*0.25, iFreq*3
    aFinal = (aSig + aHarm1 + aHarm2) * 0.5
    aReverb reverb aFinal, 0.8, 0.5
    out aReverb
endin
instr 2
    iFreq = cpsmidinn(p4)
    kAmp linseg 0, 0.1, p5, p3 - 0.1, 0
    aOut oscili kAmp, iFreq
    out aOut
endin
</CsInstruments>
<CsScore>
